  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-1">
        <div className="font-semibold text-lg text-gray-900 group-hover:text-black truncate">
          {project.name}
        </div>
        <span className="text-sm text-gray-500">{getPlatformIcon(project.platform)}</span>
      </div>
      {project.niche && (
